...
template std::vector<std::vector<uint32_t>> ReadEdgeList<uint32_t>(
    FILE* in, bool directed, bool one_based, uint32_t nodes);
template std::vector<std::vector<uint32_t>> ReadEdgeList<uint64_t>(
    FILE* in, bool directed, bool one_based, uint64_t nodes);

template class graph_t<uint32_t>;
template class graph_t<uint64_t>;
